...
petik = '```'
fake = '© Creator Sylvia Adrastea'
batre = 'tidak terdeteksi'
api = 'Ramdani Official'
github = 'sylviaadrastea'
ban =[]
//ೋ❀❀ೋ═══[SUBSCRIBE RAMDANI OFFICIAL]═══ೋ❀❀ೋ//
// Database
...
module.exports = RAMDANI = async (RAMDANI, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = RAMDANI.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "Sylvia Adrastea","listType": "SINGLE_SELECT","sections": list}}, {})
...
╰┬———╯          │ ∴°·
 ☆\ˍˍ\_ˍ|—|ˍˍ/ˍˍ/∴☆.`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© Creator Sylvia Adrastea', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
